...
const ImageSlider = ({
  ...
  }, [images, isPlaying, isShuffle, timeToShow]);
  ...
  const handleDownload = async (e) => {
    ...
    try {
      ...
      console.log("Descarga exitosa de la imagen.");
    } catch (error) {
      ...
      {(!fixedEffect && userControlsVisible) && (
        <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)}>
          ...
          <div className="modal-options">
            ...
            <button onClick={() => handleEffectSelection("fade")}>
              Fade
            </button>
            <button onClick={() => handleEffectSelection("slide")}>
              Slide
            </button>
            <button onClick={() => handleEffectSelection("zoom")}>
              Zoom
            </button>
            <button onClick={() => handleEffectSelection("rotate")}>
              Rotate
            </button>
            <button onClick={() => handleEffectSelection("flip")}>
              Flip
            </button>
            <button onClick={() => handleEffectSelection("blur")}>
              Blur
            </button>
