...
const ManageMemoryTopics = () => {
  ...
  // Set memoryData from initialData when it changes
  useEffect(() => {
    if (initialData) {
      setMemoryData({
        metadata: initialData.memoryMetadata,
  ...
  const handleAddTopic = async (e) => {
    ...
    const existingTopics = memoryData?.topics
      ? Object.keys(memoryData.topics).map((t) => t.toLowerCase())
      : [];
    ...
    try {
      ...
      if (data.success) {
        ...
        // Update memoryData with the new topic
        setMemoryData((prev) => ({
          ...prev,
          topics: {
            ...prev.topics,
      ...
      notifyFail(err.message || 'An error occurred while adding the topic');
    } finally {
    ...
    <div className="card-content">
      ...
      <div className="memory-form flex-column">
        <div className="form-group flex-column">
          ...
          <input
            type="text"
            className="Memory Title rounded p-2 onlyShow"
        ...
        <div className="form-group flex-column">
          ...
          <textarea
            style={{ resize: 'none' }}
            className="text-input rounded p-2 onlyShow"
